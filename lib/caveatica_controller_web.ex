defmodule CaveaticaControllerWeb do
  @moduledoc """
  ...
  defp html_helpers do
    quote do
      ...
      import CaveaticaControllerWeb.CoreComponents
      import CaveaticaControllerWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: CaveaticaControllerWeb.Endpoint,
        router: CaveaticaControllerWeb.Router,
        statics: CaveaticaControllerWeb.static_paths()
    end
  end
